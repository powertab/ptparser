...
protected:
    bool Test(bool record, wxLongLong startTime, const wxChar* testName,
...
inline int CompareTestSuiteNameAscending(TestSuite ** first,
    TestSuite ** second)
{
    //------Last Verified------//
    // - Dec 2, 2004
    ...
    return (wxStrcmp(classInfoFirst->GetClassName(),
        classInfoSecond->GetClassName()));
}

/// Compares two TestSuite objects by their Names (sort descending)
inline int CompareTestSuiteNameDescending(TestSuite ** first,
    TestSuite ** second)
{
    //------Last Verified------//
    // - Dec 2, 2004
    ...
    wxClassInfo* classInfoFirst = (*first)->GetClassInfo();
    wxClassInfo* classInfoSecond = (*second)->GetClassInfo();
    return (wxStrcmp(classInfoSecond->GetClassName(),
        classInfoFirst->GetClassName()));
}
