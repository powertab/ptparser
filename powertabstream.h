...
const wxWord        NULL_TAG                = 0;                    ///< Special tag indicating NULL ptrs
const wxWord        NEW_CLASS_TAG           = 0xffff;               ///< Special tag indicating new CRuntimeClass
const wxWord        CLASS_TAG               = 0x8000;               ///< 0x8000 indicates class tag (OR'd)
const wxUint32      BIG_CLASS_TAG           = 0x80000000;           ///< 0x80000000 indicates big class tag (OR'd)
const wxWord        BIG_OBJECT_TAG          = 0x7fff;               ///< 0x7fff indicates wxUint32 object tag
const wxUint32      MAX_MAP_COUNT           = 0x3ffffffe;           ///< 0x3ffffffe last valid mapCount
...
//
// The special value of 0x7FFF indicates that a wxUint32 tag follows.  This
...
const wxByte        BYTE_PLACEHOLDER            = 0xff;             ///< Placeholder used when string length > 254
const wxWord        WORD_PLACEHOLDER            = 0xffff;           ///< Placeholder used when string length > 65533
const wxWord        UNICODE_MARKER              = 0xfffe;           ///< Marker used to indicate a Unicode string
const wxUint32      DOUBLEWORD_PLACEHOLDER      = 0xffffffff;       ///< Placeholder used when string length > 4294967295
