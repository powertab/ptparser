...
bool GeneralMidiTestSuite::TestCaseMidiChannel()
{
    ...
    // TEST CASE: wxIsValidMidiChannel
    {
        ...
        {
            TEST(wxString::Format(wxT("wxIsValidMidiChannel - %d"), i),
            (wxIsValidMidiChannel(i) == (i <= LAST_MIDI_CHANNEL)));
        }
    }
    ...
    // TEST CASE: wxIsValidMidiChannelVolume
    {
        ...
        {
            TEST(wxString::Format(wxT("wxIsValidMidiChannelVolume - %d"), i),
            (wxIsValidMidiChannelVolume(i) == (i <= MAX_MIDI_CHANNEL_VOLUME)));
        }
    }
    ...
    // TEST CASE: wxIsValidMidiChannelEffectLevel
    {
        ...
        {
            TEST(
            wxString::Format(wxT("wxIsValidMidiChannelEffectLevel - %d"), i),
            (wxIsValidMidiChannelEffectLevel(i) ==
                (i <= MAX_MIDI_CHANNEL_EFFECT_LEVEL)));
        }
    }
    return (true);
}
...
bool GeneralMidiTestSuite::TestCaseMidiNote()
{
    ...
    // TEST CASE: wxIsValidMidiNote
    {
        ...
        {
            TEST(wxString::Format(wxT("wxIsValidMidiNote - %d"), i),
            (wxIsValidMidiNote(i) == (i <= MAX_MIDI_NOTE)));
        }
    }
    ...
    // TEST CASE: wxIsValidMidiNoteKey
    {
        ...
        {
            TEST(wxString::Format(wxT("wxIsValidMidiNoteKey - %d"), i),
            (wxIsValidMidiNoteKey(i) == (i <= MAX_MIDI_NOTE_KEY)));
        }
    }
    ...
    // TEST CASE: wxGetMidiNotePitch
    {
        ...
        {
            TEST(wxString::Format(wxT("wxGetMidiNotePitch - %d"), i),
                (wxGetMidiNotePitch(i) == (i % 12)));    
        }
    }
    ...
    // TEST CASE: wxGetMidiNoteOctave
    {
        ...
        for (; i <= MAX_MIDI_NOTE; i++)
        {
            TEST(wxString::Format(wxT("wxGetMidiNoteOctave - %d"), i),
                (wxGetMidiNoteOctave(i) == ((i / 12) - 1)));
        }
    }

    // TEST CASE: wxOffsetMidiNote
    {
        TEST(wxT("wxOffsetMidiNote - underflow"),
            (wxOffsetMidiNote(MIN_MIDI_NOTE, -1) == MIN_MIDI_NOTE));
        TEST(wxT("wxOffsetMidiNote - positive offset"),
            (wxOffsetMidiNote(MIN_MIDI_NOTE, 12) == (MIN_MIDI_NOTE + 12)));
        TEST(wxT("wxOffsetMidiNote - negative offset"),
            (wxOffsetMidiNote(MAX_MIDI_NOTE, -12) == (MAX_MIDI_NOTE - 12)));
        TEST(wxT("wxOffsetMidiNote - overflow"),
            (wxOffsetMidiNote(MAX_MIDI_NOTE, 1) == MAX_MIDI_NOTE));
    }
    ...
    // TEST CASE: wxIsValidMidiNoteVolume
    {
        ...
        {
            TEST(wxString::Format(wxT("wxIsValidMidiNoteVolume - %d"), i),
                (wxIsValidMidiNoteVolume(i) == (i <= MAX_MIDI_NOTE_VOLUME)));
        }
    }
...
bool GeneralMidiTestSuite::TestCaseMidiPreset()
{
    ...
    // TEST CASE: wxIsValidMidiPreset
    {
        ...
        {
            TEST(wxString::Format(wxT("wxIsValidMidiPreset - %d"), i),
                (wxIsValidMidiPreset(i) == (i <= LAST_MIDI_PRESET)));
        }
    }
    return (true);
}
...
bool GeneralMidiTestSuite::TestCaseMidiPercussionPreset()
{
    ...
    // TEST CASE: wxIsValidMidiPercussionPreset
    {
        ...
        {
            TEST(wxString::Format(wxT("wxIsValidMidiPercussionPreset - %d"), i),
            (wxIsValidMidiPercussionPreset(i) ==
                (i <= LAST_MIDI_PERCUSSION_PRESET)));
        }
    }
    return (true);
}
